...
import { BRAND_CLI, BRAND_NAME, BRAND_LINKS, isBrandLinkConfigured } from "@shared/brand"
	...
	return (
		<Panel label="Help">
			<Box flexDirection="column" gap={1}>
				<Text>{BRAND_NAME} can edit files, run terminal commands, use the browser, and more with your permission.</Text>
				...
				<Box flexDirection="column">
					...
					<Text>
						...
						<Text color={COLORS.primaryBlue}>Act</Text> mode when you're ready for {BRAND_NAME} to edit files and run
				...
				<Box flexDirection="column">
					...
					<Text>
						{"  "}
						<Text color="white">/q</Text> - Quit {BRAND_NAME}
					</Text>
				</Box>

				{isBrandLinkConfigured(BRAND_LINKS.documentation) && (
					<Text>
						For more help: <Text color={COLORS.primaryBlue}>{`${BRAND_LINKS.documentation}/cline-cli`}</Text>
					</Text>
				)}
			</Box>
		</Panel>
