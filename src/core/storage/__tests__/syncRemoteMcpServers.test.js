...
describe("syncRemoteMcpServersToSettings", () => {
    ...
    const writeSettings = async (mcpServers) => {
        await fs.writeFile(settingsPath, JSON.stringify({ mcpServers }, null, 2));
    };
    ...
    describe("edge cases", () => {
        ...
        it("should set McpHub isUpdatingFromRemoteConfig flag during write", async () => {
            ...
            await syncRemoteMcpServersToSettings([{ name: "test", url: "https://test.com" }], tempDir, mockMcpHub);
...
//# sourceMappingURL=syncRemoteMcpServers.test.js.map