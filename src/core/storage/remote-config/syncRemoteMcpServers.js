 ...
 */
export async function syncRemoteMcpServersToSettings(remoteMCPServers, settingsDirectoryPath, mcpHub) {
    try {
        ...
        for (const [serverName, serverConfig] of Object.entries(config.mcpServers)) {
            ...
            if (server.remoteConfigured === true) {
                const stillInRemoteConfig = remoteMCPServers.some((remoteServer) => remoteServer.name === serverName && remoteServer.url === server.url);
...
//# sourceMappingURL=syncRemoteMcpServers.js.map