...
const focusChainIntro = `**Task Progress Parameter:**
 ...
 */
export function getDeepPlanningPrompt(focusChainSettings, providerInfo, enableNativeToolCalls) {
 ...
 */
function generateNewTaskInstructions(enableNativeToolCalls) {
