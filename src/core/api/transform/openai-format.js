 ...
 */
function isOpenAIResponseToolId(callId) {
 ...
 */
function transformToolCallIdForNativeApi(toolId, provider) {
 ...
 */
export function convertToOpenAiMessages(anthropicMessages, provider) {
                ...
                const tool_calls = toolMessages.map((toolMessage) => {
                    ...
                    if (toolDetails) {
                        if (Array.isArray(toolDetails)) {
                            ...
                            const validDetails = toolDetails.filter((detail) => detail?.id === toolId);
