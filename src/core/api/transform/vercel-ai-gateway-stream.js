import { CLAUDE_SONNET_1M_SUFFIX, openRouterClaudeOpus461mModelId, openRouterClaudeSonnet41mModelId, openRouterClaudeSonnet451mModelId, openRouterClaudeSonnet461mModelId, } from "@shared/api";
...
export async function createVercelAIGatewayStream(client, systemPrompt, messages, model, reasoningEffort, thinkingBudgetTokens, tools) {
    ...
    let temperature = model.info?.temperature ?? 0;
    let topP;
    // R1 format conversion for DeepSeek and similar reasoning models
    const requiresR1Format = model.id.startsWith("deepseek/deepseek-r1") ||
