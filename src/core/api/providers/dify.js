        ...
        try {
            while (true) {
                ...
                if (done) {
                    ...
                    Logger.log("[DIFY DEBUG] Final state - hasYieldedContent:", hasYieldedContent, "fullText length:", fullText.length, "processedEvents:", processedEvents);
                    break;
                }
                ...
                for (const line of lines) {
                    ...
                    if (line.startsWith("data: ")) {
                        ...
                        Logger.log("[DIFY DEBUG] Non-data line (not starting with 'data:'), trying to parse as direct JSON:", JSON.stringify(line));
