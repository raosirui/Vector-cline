 ...
 */
export function extractUserPromptFromContent(userContent) {
 ...
 */
function extractFromUserContentTags(text, tags) {
    const results = [];
...
//# sourceMappingURL=extractUserPromptFromContent.js.map