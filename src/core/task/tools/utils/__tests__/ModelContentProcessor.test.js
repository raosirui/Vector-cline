    ...
    describe("applyModelContentFixes", () => {
        ...
        describe("Orchestration logic", () => {
            ...
            it("should preserve escaped chars but remove invalid chars in XML", () => {
                ...
                expect(applyModelContentFixes(input, MODELS.GEMINI, FILES.XML_DATA)).to.equal(`${ESCAPED_CHARS.LT}tag${ESCAPED_CHARS.GT}${ESCAPED_CHARS.LT}/tag${ESCAPED_CHARS.GT}`);
            });
        });
...
//# sourceMappingURL=ModelContentProcessor.test.js.map