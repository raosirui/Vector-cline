...
export const SUBAGENT_DEFAULT_ALLOWED_TOOLS = [
...
export class SubagentBuilder {
    ...
    allowedTools;
    apiHandler;
    constructor(baseConfig, subagentName) {
    ...
    buildSystemPrompt(generatedSystemPrompt) {
    ...
    buildNativeTools(context) {
        ...
        const filteredToolSpecs = toolSets
            ...
            .filter((toolSpec) => this.allowedTools.includes(toolSpec.id) &&
    ...
    resolveAllowedTools(configuredTools) {
    ...
    buildAgentIdentitySystemPrefix() {
    ...
    applyModelOverride(apiConfiguration, _mode, modelId) {
        ...
        apiConfiguration[getProviderModelIdKey(provider, mode)] = trimmedModelId;
    }
}
//# sourceMappingURL=SubagentBuilder.js.map