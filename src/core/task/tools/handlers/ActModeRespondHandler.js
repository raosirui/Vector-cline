...
export class ActModeRespondHandler {
    ...
    async execute(config, block) {
        ...
        if (config.taskState.lastToolName === ClineDefaultTool.ACT_MODE) {
            return formatResponse.toolResult(`[BLOCKED] You cannot call act_mode_respond consecutively. ` +
        ...
        return formatResponse.toolResult(`[Message displayed. Now proceed with your next tool call - ` +
