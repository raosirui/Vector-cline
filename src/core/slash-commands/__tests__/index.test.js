...
import { formatMcpPromptResponse, parseSlashCommands } from "../index";
describe("slash-commands", () => {
    ...
    describe("parseSlashCommands MCP handling", () => {
        const mockMcpPromptFetcher = async (serverName, promptName) => {
        ...
        it("should handle MCP prompt with colons in prompt name", async () => {
            const fetcherWithColons = async (serverName, promptName) => {
