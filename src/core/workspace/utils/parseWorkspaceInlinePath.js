 ...
 */
export function parseWorkspaceInlinePath(value) {
 ...
 */
export function hasWorkspaceHint(value) {
    return /^@[^:]+:/.test(value);
}
/**
 ...
 */
export function addWorkspaceHint(workspaceName, path) {
 ...
 */
export function removeWorkspaceHint(value) {
 ...
 */
export function parseMultipleWorkspacePaths(paths) {
    return paths.map((path) => parseWorkspaceInlinePath(path));
}
//# sourceMappingURL=parseWorkspaceInlinePath.js.map