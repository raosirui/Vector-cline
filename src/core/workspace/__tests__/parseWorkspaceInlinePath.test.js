...
import { addWorkspaceHint, hasWorkspaceHint, parseMultipleWorkspacePaths, parseWorkspaceInlinePath, removeWorkspaceHint, } from "../../../core/workspace/utils/parseWorkspaceInlinePath";
describe("parseWorkspaceInlinePath", () => {
    ...
    describe("edge cases", () => {
        ...
        it("should handle null/undefined", () => {
            const result = parseWorkspaceInlinePath(null);
            expect(result).to.deep.equal({
                workspaceHint: undefined,
                relPath: "",
            });
...
//# sourceMappingURL=parseWorkspaceInlinePath.test.js.map