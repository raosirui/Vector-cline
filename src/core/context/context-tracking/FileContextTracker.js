...
export class FileContextTracker {
     ...
     */
    static async cleanupOrphanedWarnings(stateManager) {
        ...
        try {
            ...
            Logger.log(`FileContextTracker: Processed ${existingTaskIds.size} tasks, found ${pendingWarningKeys.length} pending warnings, ${orphanedPendingContextTasks.length} orphaned, deleted ${orphanedPendingContextTasks.length}, took ${duration}ms`);
        }
        catch (error) {
