...
Content`);
            const skills = await discoverSkills(TEST_CWD);
            expect(skills).to.have.lengthOf(0);
            sinon.assert.calledWithMatch(Logger.warn, /missing required 'name' field/);
        });
...
Content`);
            const skills = await discoverSkills(TEST_CWD);
            expect(skills).to.have.lengthOf(0);
            sinon.assert.calledWithMatch(Logger.warn, /missing required 'description' field/);
        });
...
Content`);
            const skills = await discoverSkills(TEST_CWD);
            expect(skills).to.have.lengthOf(0);
            sinon.assert.calledWithMatch(Logger.warn, /doesn't match directory/);
        });
