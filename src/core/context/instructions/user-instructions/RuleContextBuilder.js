...
import { extractPathLikeStrings, toWorkspaceRelativePosixPath } from "./rule-conditionals";
/**
...
export class RuleContextBuilder {
     ...
     */
    static MAX_RULE_PATH_CANDIDATES = 100;
    static async buildEvaluationContext(deps) {
        return {
     ...
     */
    static extractPathsFromApplyPatch(input) {
    ...
    static async getRulePathContext(deps) {
        const candidates = [];
...
//# sourceMappingURL=RuleContextBuilder.js.map