...
import { DEFAULT_EXTERNAL_IDCS_CLIENT_ID, DEFAULT_EXTERNAL_IDCS_URL, DEFAULT_EXTERNAL_IDSC_SCOPES, DEFAULT_INTERNAL_IDCS_CLIENT_ID, DEFAULT_INTERNAL_IDCS_URL, DEFAULT_INTERNAL_IDSC_SCOPES, OCA_CONFIG_PATH, } from "../utils/constants";
/**
 ...
 */
export async function generateOpcRequestId(taskId, token) {
 ...
 */
export async function createOcaHeaders(accessToken, taskId) {
