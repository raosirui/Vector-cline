...
describe("McpOAuthRedirectResolver", () => {
    ...
    describe("isRedirectCompatible", () => {
        it("should return true when URLs are identical", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("http://127.0.0.1:48801/mcp-auth/callback/abc123", "http://127.0.0.1:48801/mcp-auth/callback/abc123").should.be.true();
        });
        it("should return true for identical vscode:// URLs", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("vscode://saoudrizwan.claude-dev/mcp-auth/callback/abc123", "vscode://saoudrizwan.claude-dev/mcp-auth/callback/abc123").should.be.true();
        });
        it("should return true for identical https:// URLs", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("https://codespace-abc.github.dev/mcp-auth/callback/abc123", "https://codespace-abc.github.dev/mcp-auth/callback/abc123").should.be.true();
        });
        it("should return false when saved URL is undefined (legacy state)", () => {
            McpOAuthRedirectResolver.isRedirectCompatible(undefined, "http://127.0.0.1:48801/mcp-auth/callback/abc123").should.be.false();
        });
        it("should return false when ports differ", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("http://127.0.0.1:48801/mcp-auth/callback/abc123", "http://127.0.0.1:48802/mcp-auth/callback/abc123").should.be.false();
        });
        it("should return false when schemes differ (VSCode → JetBrains migration)", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("vscode://saoudrizwan.claude-dev/mcp-auth/callback/abc123", "http://127.0.0.1:48801/mcp-auth/callback/abc123").should.be.false();
        });
        it("should return false when schemes differ (JetBrains → VSCode migration)", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("http://127.0.0.1:48801/mcp-auth/callback/abc123", "vscode://saoudrizwan.claude-dev/mcp-auth/callback/abc123").should.be.false();
        });
        it("should return false when paths differ (different server hash)", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("http://127.0.0.1:48801/mcp-auth/callback/hash1", "http://127.0.0.1:48801/mcp-auth/callback/hash2").should.be.false();
        });
        it("should return false when codespace domains differ", () => {
            McpOAuthRedirectResolver.isRedirectCompatible("https://codespace-old.github.dev/mcp-auth/callback/abc123", "https://codespace-new.github.dev/mcp-auth/callback/abc123").should.be.false();
        });
    });
    describe("resolve", () => {
        ...
        it("should reuse port when saved loopback URL port is available", async () => {
            ...
            const getCallbackUrl = async (path, preferredPort) => {
...
//# sourceMappingURL=McpOAuthRedirectResolver.test.js.map