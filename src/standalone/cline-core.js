...
function setupHostProvider(extensionContext, extensionDir, dataDir) {
    ...
    const getCallbackUrl = (path, preferredPort) => {
    ...
    HostProvider.initialize(createWebview, createDiffView, createCommentReview, createTerminalManager, new ExternalHostBridgeClientManager(), log, getCallbackUrl, getBinaryLocation, extensionDir, dataDir);
}
/**
