...
export async function retryWithBackoff(operation, options = {}) {
    const { maxAttempts = 3, baseDelayMs = 50, maxDelayMs = Number.POSITIVE_INFINITY, multiplier = 2, operationName = "Operation", shouldRetry = () => true, onRetry, } = options;
    let lastError;
    ...
    throw new Error(`${operationName} failed after ${maxAttempts} attempts: ${lastError instanceof Error ? lastError.message : String(lastError)}`);
}
/**
