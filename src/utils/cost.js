...
export function calculateApiCostAnthropic(modelInfo, inputTokens, outputTokens, cacheCreationInputTokens, cacheReadInputTokens, thinkingBudgetTokens) {
    ...
    return calculateApiCostInternal(modelInfo, inputTokens, outputTokens, cacheCreationInputTokensNum, cacheReadInputTokensNum, inputTokens + cacheCreationInputTokensNum + cacheReadInputTokensNum, // used for tiered price lookup
    thinkingBudgetTokens);
}
...
export function calculateApiCostQwen(modelInfo, inputTokens, // For Qwen-style, this includes cached tokens
outputTokens, cacheCreationInputTokens, cacheReadInputTokens, thinkingBudgetTokens) {
    const cacheCreationInputTokensNum = cacheCreationInputTokens || 0;
    const cacheReadInputTokensNum = cacheReadInputTokens || 0;
    // Calculate non-cached tokens for the internal function's 'inputTokens' parameter
