 ...
 */
async function isDirectoryPattern(sourceDir, pattern) {
 ...
 */
async function copyDirectoryNative(source, target) {
 ...
 */
async function copyFilesInBatches(files, sourceDir, targetDir) {
    const errors = [];
    let copiedCount = 0;
 ...
 */
export async function copyWorktreeIncludeFiles(sourceDir, targetDir) {
    const errors = [];
    let copiedCount = 0;
 ...
 */
export async function hasWorktreeInclude(dir) {
    try {
...
//# sourceMappingURL=worktree-include.js.map