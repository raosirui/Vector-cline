...
describe("Worktree Include Utilities", () => {
    ...
    describe("copyWorktreeIncludeFiles", () => {
        ...
        it("should copy individual files matching both patterns", async () => {
            ...
            const logExists = await fs.access(path.join(tgt, "test.log")).then(() => true, () => false);
            logExists.should.be.true();
            // Verify the txt file was NOT copied
            const txtExists = await fs.access(path.join(tgt, "test.txt")).then(() => true, () => false);
        ...
        it("should copy entire directories using native cp", async () => {
            ...
            const pkgExists = await fs.access(path.join(tgt, "node_modules", "pkg", "index.js")).then(() => true, () => false);
...
//# sourceMappingURL=worktree-include.test.js.map