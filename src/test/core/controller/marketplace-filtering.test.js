...
describe("Controller Marketplace Filtering", () => {
    ...
    beforeEach(async () => {
        ...
        if (!HostProvider.isInitialized()) {
            ...
            HostProvider.initialize(() => null, // createWebviewProvider
            () => null, // createDiffViewProvider
            () => null, // createCommentReviewController
            () => null, // createTerminalManager
            mockHostBridge, () => { }, // logToChannel
            async (path) => `http://localhost${path}`, // getCallbackUrl
...
//# sourceMappingURL=marketplace-filtering.test.js.map