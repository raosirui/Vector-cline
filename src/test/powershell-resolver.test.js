...
import "should";
import { probeWindowsExecutable, getFallbackWindowsPowerShellPath, getWindowsPowerShellCandidates, resetPowerShellResolverCacheForTesting, setPowerShellProbeForTesting, resolveWindowsPowerShellExecutable, } from "../utils/powershell";
import { WINDOWS_POWERSHELL_LEGACY_PATH } from "../utils/shell";
describe("PowerShell resolver", () => {
    let originalProgramFiles;
    let originalProgramW6432;
    beforeEach(() => {
...
//# sourceMappingURL=powershell-resolver.test.js.map