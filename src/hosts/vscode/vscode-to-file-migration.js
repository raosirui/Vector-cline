 ...
 * - ephemeral/transient
 */
const SKIP_GLOBAL_STATE_KEYS = new Set([
 ...
 */
export async function exportVSCodeStorageToSharedFiles(vscodeContext, storage) {
	const result = {
		migrated: false,
		globalStateCount: 0,
		secretsCount: 0,
	...
	const globalVersion = storage.globalState.get(MIGRATION_VERSION_KEY)
	const workspaceVersion = storage.workspaceState.get(MIGRATION_VERSION_KEY)
...
//# sourceMappingURL=vscode-to-file-migration.js.map
