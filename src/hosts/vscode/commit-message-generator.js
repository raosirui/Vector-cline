 ...
 */
export async function getGitDiffStagedFirst(cwd) {
	try {
...
export async function generateCommitMsg(controller, scm) {
	try {
...
async function orchestrateWorkspaceCommitMsgGeneration(controller, repos) {
...
async function generateCommitMsgForRepository(controller, repository) {
...
async function performCommitMsgGeneration(controller, gitDiff, inputBox) {
	try {
