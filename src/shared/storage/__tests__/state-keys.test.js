...
import { applyTransform, GLOBAL_STATE_DEFAULTS, GlobalStateAndSettingKeys, getDefaultValue, hasTransform, isAsyncProperty, isComputedProperty, isGlobalStateKey, isLocalStateKey, isSecretKey, isSettingsKey, LocalStateKeys, SETTINGS_DEFAULTS, SETTINGS_TRANSFORMS, SecretKeys, SettingsKeys, } from "../state-keys";
// ============================================================================
// Test Helpers
// ============================================================================
/**
 ...
 */
function assertTypeMatch(value, expectedType, key) {
 ...
 */
function inferExpectedType(value) {
    if (value === undefined) {
        return "undefined";
    }
    if (value === null) {
...
describe("State Keys Type Safety", () => {
    describe("Type-Value Consistency", () => {
        ...
        it("should have GlobalState defaults with correct runtime types", () => {
            const defaults = GLOBAL_STATE_DEFAULTS;
        ...
        it("should not have undefined defaults masquerading as non-optional types", () => {
            ...
            const allDefaults = { ...GLOBAL_STATE_DEFAULTS, ...SETTINGS_DEFAULTS };
    ...
    describe("Key Array Synchronization", () => {
        ...
        it("should have SettingsKeys match SETTINGS_DEFAULTS keys", () => {
            ...
            const exportedKeys = new Set(SettingsKeys);
        ...
        it("should have GlobalStateAndSettingKeys be a superset of SettingsKeys", () => {
            const combinedSet = new Set(GlobalStateAndSettingKeys);
        ...
        it("should have no duplicate keys in exported arrays", () => {
            ...
            expect(new Set(GlobalStateAndSettingKeys).size, "GlobalStateAndSettingKeys has duplicates").to.equal(GlobalStateAndSettingKeys.length);
        });
    ...
    describe("Type Exports", () => {
        ...
        it("should export usable key types", () => {
            ...
            const globalKey = "isNewUser";
            const settingsKey = "preferredLanguage";
            const secretKey = "apiKey";
            const localKey = "localClineRulesToggles";
...
//# sourceMappingURL=state-keys.test.js.map