...
import { AwsBedrockSettingsSchema, ClineSettingsSchema, EnterpriseTelemetrySchema, OpenAiCompatibleSchema, PromptUploadingSchema, RemoteConfigSchema, S3AccessKeySettingsSchema, } from "../schema";
describe("Remote Config Schema", () => {
    ...
    describe("S3AccessKeySettingsSchema", () => {
        ...
        it("should reject S3 settings with invalid intervalMs type", () => {
            expect(() => S3AccessKeySettingsSchema.parse({
                bucket: "my-bucket",
                accessKeyId: "AKIAIOSFODNN7EXAMPLE",
                secretAccessKey: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY",
                intervalMs: "30000",
    ...
    describe("PromptUploadingSchema", () => {
        ...
        it("should reject s3AccessSettings with missing required fields", () => {
            expect(() => PromptUploadingSchema.parse({
                enabled: true,
                s3AccessSettings: {
                    accessKeyId: "AKIAIOSFODNN7EXAMPLE",
                    secretAccessKey: "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY",
