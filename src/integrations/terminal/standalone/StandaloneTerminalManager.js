...
export class StandaloneTerminalManager {
    ...
    registry = new StandaloneTerminalRegistry();
     ...
     */
    trackBackgroundCommand(process, command, existingOutput = []) {
    ...
    cancelBackgroundCommand(id) {
        ...
        // Terminate process
        if (command.process && typeof command.process.terminate === "function") {
            ;
...
//# sourceMappingURL=StandaloneTerminalManager.js.map