 ...
 */
export async function tryAcquireCheckpointLockWithRetry(cwdHash, taskId) {
    const options = {
 ...
 * @param cwdHash - The hash of the working directory
 */
export async function releaseCheckpointLock(cwdHash, taskId) {
    await releaseFolderLock(taskId, `${CHECKPOINTS_BASE_PATH}/${cwdHash}`);
}
//# sourceMappingURL=CheckpointLockUtils.js.map