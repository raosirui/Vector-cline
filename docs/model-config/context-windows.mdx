...
2. **File contents** - Any files you've shared or Vector has read
3. **Tool outputs** - Results from executed commands
4. **System prompts** - Vector's instructions (minimal impact)
...
Vector can automatically summarize long conversations:
...
**A:** Vector shows token usage in the interface. Watch for the context meter approaching limits.

### Q: What happens when I exceed the context limit?
**A:** Vector will either:
