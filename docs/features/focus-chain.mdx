...
Focus Chain is automatic todo list management with real-time progress tracking. It helps Vector work on longer tasks by maintaining a visible checklist that persists across context window resets.
...
- Work where you want visibility into Vector's plan
...
1. Click the gear icon in the Vector sidebar
2. Navigate to "Features"
3. Check "Enable Focus Chain"
4. Optionally adjust "Remind Vector Interval" (default: 6 messages)

| Setting | Default | Description |
|---------|---------|-------------|
| Enable Focus Chain | Disabled | Enables enhanced task progress tracking |
| Remind Vector Interval | 6 | How often Vector updates the todo list (1-100 messages) |

## How It Works

When you start a task with Focus Chain enabled, Vector:
...
Need to adjust the plan? Click the edit button in the expanded todo view. A markdown file opens in your editor where you can add, remove, or reorder items. Save the file and Vector automatically detects your updates.
