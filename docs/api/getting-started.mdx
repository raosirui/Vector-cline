...
description: "Create an API key and make your first request to the Vector API in under a minute."
---
...
- A Vector account at [app.cline.bot](https://app.cline.bot)
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Examples" icon="code" href="/api/sdk-examples">
    Use the API from Python, Node.js, or the Vector CLI.
  </Card>
</CardGroup>
