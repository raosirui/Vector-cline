...
Vector CLI requires **Node.js version 20 or higher**. We recommend Node.js 22 for the best experience.
...
#### Option 1: Sign in with Vector (Recommended)

Select **"Sign in with Vector"** to authenticate with your Vector account via OAuth. Your browser opens automatically to complete sign-in.
...
Already using another AI coding CLI? Vector can import your existing configuration:
...
If Vector responds with an answer, your installation and authentication are complete.
...
Now you're ready to use Vector. Choose how you want to work:
...
You'll see the Vector welcome screen. Type your task and press Enter. Use:
...
- **[Headless Mode](/cline-cli/three-core-flows)** - Run Vector autonomously in scripts, CI/CD pipelines, and automated workflows
