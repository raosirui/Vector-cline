...
description: "Install Vector CLI on macOS, Linux, or Windows and configure your AI provider"
---

Vector CLI brings the full power of Vector to your terminal. In just a few minutes, you can install the CLI, authenticate with your preferred AI provider, and start running tasks from any directory on your machine.
