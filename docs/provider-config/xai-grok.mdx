---
title: "xAI (Grok)"
description: "Learn how to configure and use xAI's Grok models with Vector, including API key setup, supported models, and reasoning capabilities."
---
...
3.  **Create a Key:** Click to create a new API key. Give your key a descriptive name (e.g., "Vector").
4.  **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

### Supported Models

Vector supports the following xAI Grok models:
