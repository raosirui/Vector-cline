---
title: "MiniMax"
description: "Learn how to configure and use MiniMax models with Vector. Access MiniMax-M2 series models with large context windows, prompt caching, and reasoning support."
---
...
Vector supports the following MiniMax models:
