---
title: "Qwen Code"
description: "Learn how to use Qwen Code with Vector. Access free Qwen3 Coder models through the Qwen Code platform for coding tasks."
---
...
Vector supports the following Qwen Code models (all free):
