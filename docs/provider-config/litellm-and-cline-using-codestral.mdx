---
title: "LiteLLM & Vector (using Codestral)"
description: "Learn how to set up and run LiteLLM with Vector using the Codestral model. This guide covers Docker setup, configuration, and integration with Vector."
---

### Using LiteLLM with Vector

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Vector.
...
2. **Setup Vector**
    ...
    Once the LiteLLM server is up and running you can set it up in Vector:
...
-   [Vector Discord Community](https://discord.gg/cline)
