---
title: "Fireworks AI"
description: "Learn how to configure and use Fireworks AI's lightning-fast inference platform with Vector. Experience up to 4x faster inference speeds with optimized models and competitive pricing."
---
...
Vector supports the following Fireworks AI models:
