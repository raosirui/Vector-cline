---
title: "Google Gemini"
description: "Learn how to configure and use Google Gemini models with Vector. Access Gemini 3, 2.5, and 2.0 series models with large context windows and multimodal capabilities."
---
...
Vector supports the following Google Gemini models:
...
Enable extended thinking in Vector settings to leverage these capabilities for complex coding and reasoning tasks.
