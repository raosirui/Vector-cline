---
title: "Dify.ai"
description: "Learn how to configure and use Dify.ai workflows with Vector. Connect to Dify's workflow-based AI platform for custom model orchestration."
---

Dify.ai is a workflow-based AI platform that allows you to build and deploy custom AI workflows. When used with Vector, Dify acts as a proxy to your configured workflows - no model selection is needed as models are configured within Dify itself.
...
-   **No Model Selection:** Models are configured within Dify workflows, not in Vector.
