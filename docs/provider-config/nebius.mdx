...
description: "Learn how to configure and use Nebius AI Studio with Vector. Access DeepSeek, Qwen, Llama, and other open-source models with competitive pricing."
---
...
Vector supports the following Nebius models:
