---
title: "Alibaba Qwen"
description: "Learn how to configure and use Alibaba Cloud's Qwen models with Vector. Access Qwen3 series models with thinking capabilities and extensive model options."
---
...
Vector supports Qwen models with separate catalogs for International and China regions:
