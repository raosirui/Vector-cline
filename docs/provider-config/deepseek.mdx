---
title: "DeepSeek"
description: "Learn how to configure and use DeepSeek models like deepseek-chat and deepseek-reasoner with Vector."
---

Vector supports accessing models through the DeepSeek API, including `deepseek-chat` and `deepseek-reasoner`.
...
3.  **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "Vector").
4.  **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

### Supported Models

Vector supports the following DeepSeek models:
...
1.  **Open Vector Settings:** Click the ⚙️ icon in the Vector panel.
