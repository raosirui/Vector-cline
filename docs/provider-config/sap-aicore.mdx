---
title: "SAP AI Core"
description: "Learn how to configure and use LLM models from Generative AI Hub in SAP AI Core with Vector."
---
...
- **Service Plan Requirement:** You must have the SAP AI Core `extended` service plan to use LLMs with Vector. Other service plans do not provide access to Generative AI Hub.
