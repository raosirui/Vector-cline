---
title: "OpenRouter"
description: "Learn how to use OpenRouter with Vector to access a wide variety of language models through a single API."
---
...
OpenRouter supports a large and growing number of models. Vector automatically fetches the list of available models. Refer to the [OpenRouter Models page](https://openrouter.ai/models) for the complete and up-to-date list.
