---
title: "Hugging Face"
description: "Learn how to configure and use Hugging Face Inference Providers with Vector. Access open-source models with free inference through the Hugging Face ecosystem."
---
...
Vector supports the following Hugging Face models (all currently free):
