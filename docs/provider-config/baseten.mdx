---
title: "Baseten"
description: "Learn how to configure and use Baseten's Model APIs with Vector. Access frontier open-source models with enterprise-grade performance, reliability, and competitive pricing."
---
...
3.  **Create a Key:** Generate a new API key. Give it a descriptive name (e.g., "Vector").
...
**IMPORTANT: For Kimi K2 Thinking:** To use the `moonshotai/Kimi-K2-Thinking` model, you must enable **Native Tool Call (Experimental)** in Vector settings. This setting allows Vector to call tools through their native tool processor and is required for this reasoning model to function properly.

### Supported Models

Vector supports all current models under Baseten Model APIs, including:
...
-   **Dynamic Model Updates:** Vector automatically fetches the latest model list from Baseten, ensuring access to new models as they're released in real time.
