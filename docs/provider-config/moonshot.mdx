---
title: "Moonshot"
description: "Learn how to configure and use Moonshot AI's Kimi K2 models with Vector. Access state-of-the-art MoE models with large context windows."
---
...
Vector supports the following Moonshot models:
