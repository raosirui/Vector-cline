---
title: "Groq"
description: "Learn how to configure and use Groq's lightning-fast inference with Vector. Access models from OpenAI, Meta, DeepSeek, and more on Groq's purpose-built LPU architecture."
---
...
3.  **Create a Key:** Navigate to the API Keys section and create a new API key. Give your key a descriptive name (e.g., "Vector").
4.  **Copy the Key:** Copy the API key immediately. You will not be able to see it again. Store it securely.

### Supported Models

Vector supports the following Groq models:
