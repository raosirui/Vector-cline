---
title: "Cerebras"
description: "Learn how to configure and use Cerebras's ultra-fast inference with Vector. Experience up to 2,600 tokens per second with wafer-scale chip architecture and real-time reasoning models."
---
...
Vector supports the following Cerebras models:
...
#### No IDE Lock-In
Works with any OpenAI-compatible tool-Cursor, Continue.dev, Vector, or any other editor that supports OpenAI endpoints.
