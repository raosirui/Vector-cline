---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with Vector. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
- Works exclusively through coding tools like Vector
...
To use the GLM Coding Plans with Vector:
...
3. **Configure in Vector:** Open Vector settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="Vector settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to Vector, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
