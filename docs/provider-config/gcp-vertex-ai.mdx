---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with Vector to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
-   **Open Vector Settings:**\
    Click the settings ⚙️ icon within the Vector extension
-   **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the Vector extension picks up the new credentials
...
4. **Set the Environment Variable:**
    ...
    - This instructs Google Cloud client libraries (and Vector) to use this key
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the Vector VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
-   **Configure Vector in VS Code:**\
    Install Vector, enter your project ID, select the appropriate region, and choose the model
...
_This guide will be updated as GCP Vertex AI and Vector evolve. Always refer to the latest documentation for current practices._
