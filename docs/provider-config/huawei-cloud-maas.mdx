...
description: "Learn how to configure and use Huawei Cloud Model-as-a-Service with Vector. Access DeepSeek and Qwen models through Huawei's cloud infrastructure."
---
...
Vector supports the following Huawei Cloud MaaS models:
