---
title: "SambaNova"
description: "Learn how to configure and use SambaNova's fast inference with Vector. Access Meta Llama, DeepSeek, and Qwen models on SambaNova's custom hardware."
---
