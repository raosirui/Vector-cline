...
description: "Templates for different types of Vector documentation"
---
...
Use this template when explaining a Vector feature. Focus on what it does, how to use it, and real examples.
...
### Example: Vector Tools Guide

The [Vector Tools Guide](/tools-reference/all-cline-tools) follows this pattern:
...
<Tip>
  ...
  Vector helps you fill in each section based on your project.
</Tip>
