---
title: "All Vector Tools"
sidebarTitle: "All Vector Tools"
description: "Complete reference for Vector's built-in tools and capabilities."
---

Vector has access to a set of tools for various tasks. This reference covers all available tools and how to use them.
...
MCP tools extend Vector's capabilities through external integrations. See [MCP documentation](/mcp/mcp-overview) for details.
...
1. Vector proposes creating a new task with summarized context
...
Type `/newtask` in chat to manually trigger this process. Vector will:
...
For the most up-to-date implementation details, see the [Vector repository](https://github.com/cline/cline/blob/main/src/core/prompts/system-prompt/tools).
