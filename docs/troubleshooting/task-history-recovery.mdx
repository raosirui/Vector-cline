...
description: "How to recover and reconstruct your Vector task history"
---

Sometimes when you update Vector or when certain settings change, you might lose access to your previous tasks. This guide will help you recover and reconstruct your Vector task history, so you can regain access to your important conversations and work.
...
Vector creates backups automatically. Find them in the `state/` folder:
...
Switching to a new computer? You can bring all your Vector conversations with you. The process is the same whether you're using VS Code or a JetBrains IDE.

<Steps>
	<Step title="Locate and copy your Vector data">
	...
	<Step title="Set up your new machine">
		On your **new machine**, install your IDE (VS Code or JetBrains) and the Vector extension.
	</Step>
	...
	<Step title="Launch and verify">
		Open your IDE. Your task history should now appear in Vector.
	</Step>
</Steps>
...
Run **"Vector: Reconstruct Task History"** from the command palette. If that doesn't work, check if there's a backup file to restore.

### History lost after reinstalling VS Code
VS Code usually keeps extension data when uninstalled. Simply reinstall Vector and run the recovery command.
