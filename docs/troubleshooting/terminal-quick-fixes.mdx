...
1. Click **Settings** (top right of Vector chat)
...
-   **Switch to bash** (solves most instances)
    ...
    1. Within Vector, left-click the **Settings** button in the top right-hand corner of the chat window
...
-   Select **"WSL Bash"** in Vector settings, under **"Terminal Settings"**
