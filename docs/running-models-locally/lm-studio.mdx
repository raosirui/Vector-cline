---
title: "LM Studio"
description: "A quick guide to setting up LM Studio for local AI model execution with Vector."
---

## Setting Up LM Studio with Vector

Run AI models locally using LM Studio with Vector.

### Prerequisites

-   Windows, macOS, or Linux computer with AVX2 support
-   Vector installed in VS Code
...
<Frame>
	<img
		...
		alt="Configuring Vector with LM Studio"
	/>
</Frame>

### Recommended Model and Settings

For the best experience with Vector, use **Qwen3 Coder 30B A3B Instruct**. This model delivers strong coding performance and reliable tool use.
...
For optimal performance with local models, enable compact prompts in Vector settings. This reduces the prompt size by 90% while maintaining core functionality.

Navigate to Vector Settings → Features → Use Compact Prompt and toggle it on.

### Important Notes

-   Start LM Studio before using with Vector
...
1. If Vector can't connect to LM Studio:
