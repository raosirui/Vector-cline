...
The Vector extension must be installed in VS Code and you need to be signed into your organization account. If you haven't installed Vector yet, follow our [installation guide](/getting-started/installing-cline).

<Info>
**Quick Check**: Open the Vector panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
Open VS Code and access the Vector settings panel using either of these methods:

- Click the settings icon (⚙️) in the Vector panel
...
4. Vector will use your default Google Cloud credentials automatically
</Accordion>
...
4. Vector will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in Vector to verify your credentials work correctly with the configured Vertex AI project and region.
...
- **Image Analysis**: Upload images directly in Vector for analysis
...
Confirm you're signed into the correct Vector organization. Verify your administrator has saved the Vertex AI configuration and that you have the latest version of the Vector extension.
