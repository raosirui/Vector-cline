...
description: "This guide explains how administrators configure LiteLLM as the organization-wide LLM provider for Vector."
---


As an administrator, you can add LiteLLM as the organization-wide LLM provider for all Vector users through the hosted admin console. This centralized approach provides unified access to multiple AI models through your LiteLLM proxy interface.
...
Once saved, all organization members signed into the Vector extension will automatically use LiteLLM with your configured settings. They won't be able to select other providers or switch to their personal Vector accounts.
