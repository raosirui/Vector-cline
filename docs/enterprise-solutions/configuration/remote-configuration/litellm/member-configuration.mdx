...
<Tip>
API keys are stored locally in VS Code and are only used by the Vector extension.
</Tip>
</Accordion>
...
Send a test message in Vector to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct Vector organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the Vector extension.
...
- Regularly update the Vector extension for security patches
