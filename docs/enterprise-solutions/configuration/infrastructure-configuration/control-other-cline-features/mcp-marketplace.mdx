...
The MCP Marketplace lets developers discover and install MCP servers that extend Vector's capabilities. For Enterprise administrators, this page covers how to control marketplace access, restrict which servers are available, and push pre-configured MCP servers to your organization.
...
<AccordionGroup>
  ...
  <Accordion title="Internal MCP Servers" icon="building">
    ...
    - Connect Vector to internal APIs, databases, and knowledge bases
