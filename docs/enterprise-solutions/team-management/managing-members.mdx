...
description: "Complete guide to managing team members, roles, and permissions in your Vector Enterprise organization"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Member" icon="user" color="#560BAD">
    **Developers & contributors**
    ...
    Can use Vector with shared resources but cannot change settings. The safest default for most team members.
  </Card>
</CardGroup>
...
<Note>
These requirements ensure that only authenticated users from your company can access your Vector organization, preventing unauthorized access.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Offboarding Process" icon="door-open">
    Create a standard offboarding checklist: remove from Vector, revoke IDP access, document in audit log, and reassign any critical responsibilities.
  </Card>
</CardGroup>
...
<Tip>
**Getting Started Fast?** The quickest path is: 1) Invite your team as Members, 2) Configure one API provider, 3) Let your team start using Vector. You can refine roles and settings later.
</Tip>
