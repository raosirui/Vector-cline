...
description: "Configure Single Sign-On (SSO) for Vector Enterprise via WorkOS AuthKit."
---

## Overview
Vector Enterprise integrates with your identity provider (IdP) via **WorkOS AuthKit** for SSO.

This page describes, at a high level, how SSO is set up for Vector Enterprise using WorkOS AuthKit.
...
1) **Vector Dashboard (app.cline.bot)**
...
## Using the Vector Dashboard
Use the Vector Dashboard at https://app.cline.bot to:
...
To connect your IdP to Vector Enterprise, configure your identity provider in **WorkOS AuthKit**:
...
Vector Enterprise’s default SSO integration is **via WorkOS**.
...
## Troubleshooting
- **Redirect URI mismatch**: confirm the redirect/callback URL configured in WorkOS matches what was provided during your Vector Enterprise onboarding.
