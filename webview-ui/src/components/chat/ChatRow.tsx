...
import { BRAND_LINKS, BRAND_NAME, brandText, isBrandLinkConfigured } from "@shared/brand"
			...
			switch (type) {
				...
				case "mistake_limit_reached":
					return [
						...
						<span className="text-error font-bold">{brandText.isDoing("having trouble...")}</span>,
					]
				case "command":
					return [
						<TerminalIcon className="text-foreground size-2" />,
						<span className="font-bold text-foreground">{brandText.wantsTo("execute this command:")}</span>,
					]
				case "use_mcp_server":
					...
					return [
						...
						<span className="ph-no-capture font-bold text-foreground break-words">
							{brandText.wantsTo(mcpServerUse.type === "use_mcp_tool" ? "use a tool" : "access a resource")} on the{" "}
				...
				case "followup":
					return [
						...
						<span className="font-bold text-foreground">{brandText.hasThing("a question:")}</span>,
					]
				default:
					return [null, null]
			}
			...
			switch (tool.tool) {
				case "editedExistingFile":
					...
					const editToolTitle = isApplyingPatch
						? brandText.isDoing("creating patches to edit this file:")
						: brandText.wantsTo("edit this file:")
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								{tool.operationIsLocatedInWorkspace === false &&
									toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
								<span style={{ fontWeight: "bold" }}>{brandText.wantsTo("delete this file:")}</span>
							</div>
							<CodeAccordian
								// isLoading={message.partial}
								code={tool.content}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								{tool.operationIsLocatedInWorkspace === false &&
									toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
								<span className="font-bold">{brandText.wantsTo("create a new file:")}</span>
							</div>
							{backgroundEditEnabled && tool.path && tool.content ? (
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								{tool.operationIsLocatedInWorkspace === false &&
									toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
								<span className="font-bold">{brandText.wantsTo("read this file:")}</span>
							</div>
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? brandText.wantsTo("view the top level files in this directory:")
										: brandText.viewed("the top level files in this directory:")}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? brandText.wantsTo("recursively view all files in this directory:")
										: brandText.recursivelyViewed("all files in this directory:")}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? brandText.wantsTo("view source code definition names used in this directory:")
										: brandText.viewed("source code definition names used in this directory:")}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									{brandText.wantsTo("search this directory for")} <code className="break-all">{tool.regex}</code>:
								</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">{brandText.isDoing("condensing the conversation:")}</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									{message.type === "ask"
										? brandText.wantsTo("fetch content from this URL:")
										: brandText.fetched("content from this URL:")}
								</span>
							</div>
							<div
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									{message.type === "ask"
										? brandText.wantsTo("search the web for:")
										: brandText.searched("the web for:")}
								</span>
							</div>
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">{brandText.loaded("the skill:")}</span>
							</div>
						...
						return (
							<div className="flex flex-col bg-warning/20 p-2 rounded-xs border border-error">
								...
								<div className="text-foreground opacity-80">
									{BRAND_NAME} may have trouble viewing the command's output. Please update VSCode (
									<code>CMD/CTRL + Shift + P</code> → "Update") and make sure you're using a supported shell:
									zsh, bash, fish, or PowerShell (<code>CMD/CTRL + Shift + P</code> → "Terminal: Select Default
									Profile").
									{isBrandLinkConfigured(BRAND_LINKS.github) && (
										<a className="px-1" href={`${BRAND_LINKS.github}/wiki/Troubleshooting-%E2%80%90-Shell-Integration-Unavailable`}>
					...
					case "new_task":
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">{brandText.wantsTo("start a new task:")}</span>
								</div>
					...
					case "condense":
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">{brandText.wantsTo("condense your conversation:")}</span>
								</div>
								<NewTaskPreview context={message.text || ""} />
							</div>
						)
					case "report_bug":
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">{brandText.wantsTo("create a Github issue:")}</span>
								</div>
